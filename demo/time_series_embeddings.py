"""Build native time-series representations from generated synthetic market data.

Uses the market-data smoke dataset generated by ``demo/generate_market_data.py``.
The workflow creates deterministic native two-channel representations and searches
them with DuckDB's exact vector engine.
"""
