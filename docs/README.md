...
- [Transformers series embedding provider](design/transformers-series-embeddings.md) —
  proposed versioned temporal semantics, model adapters, implementation sequence,
  and qualification gates for native Transformers time-series backbones.
